        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div>
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="font-extrabold text-[#7A2A2A]  text-sm tracking-widest uppercase font-heading ">Capabilities</h2>
            </div>
            <h3 className="font-extrabold font-heading text-4xl md:text-5xl font-heading text-[#F3EEE2] leading-tight max-w-2xl">
