...
const CaseBlock: React.FC<{ data: typeof cases[0], onInView: (id: number) => void }> = ({ data, onInView }) => {
  ...
  return (
    <div ref={ref} className="min-h-[70vh] flex flex-col justify-center py-20 border-b border-[#8C877A]/20 last:border-0">
      ...
      <h3 className="font-extrabold font-heading text-4xl md:text-5xl font-heading text-[#F3EEE2] mb-6 leading-tight">
        {data.title}
      </h3>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="md:hidden py-24 space-y-24">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="font-extrabold text-[#7A2A2A]  text-sm tracking-widest uppercase font-heading ">Selected Work</h2>
          </div>
          {cases.map((c) => (
            <div key={c.id} className="flex flex-col gap-6">
              ...
              <div>
                ...
                <h3 className="font-extrabold text-3xl font-heading text-[#F3EEE2] mb-4">{c.title}</h3>
