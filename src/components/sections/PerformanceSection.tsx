      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="p-8 border border-border rounded-sm hover:border-primary transition-colors bg-background">
            <h3 className="font-heading text-xl mb-3 text-primary">Paid Social</h3>
          ...
          <div className="p-8 border border-border rounded-sm hover:border-primary transition-colors bg-background">
            <h3 className="font-heading text-xl mb-3 text-primary">SEO & Search</h3>
          ...
          <div className="p-8 border border-border rounded-sm hover:border-primary transition-colors bg-background">
            <h3 className="font-heading text-xl mb-3 text-primary">CRO</h3>
